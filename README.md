...
# Resume
## 2021/03 - 
合同会社voicheer の代表取締役CTO を名乗らせていただいております。  
[https://voicheer.fun](https://voicheer.fun) の社長業と開発を行っております。

また、技術顧問として2件お手伝いさせていただいております。

## 2020/01 - 2021/03
フリーランスとして活動をしていました。  
フルタイムでSRE としてのJoin を2件、技術顧問を3件させていただきました。  
使用した技術スタックは以下になります。

TypeScript, Golang, Kotolin, GKE, ECS, etc...
